...
parser.add_argument('--input_dir', default='/path', type=str, help='Directory of validation images')
parser.add_argument('--result_dir', default='/path', type=str, help='Directory for results')
parser.add_argument('--weights', default='/path', type=str, help='Path to weights')
parser.add_argument('--dataset', default='camvid', type=str, help='Test Dataset')
...
# rgb_dir_test = os.path.join(args.input_dir, 'train', 'input')
